...
// UpdateIPAMLeaseIPs provides a mock function with given fields: ipamLease, ips
func (_m *InterfaceOVN) UpdateIPAMLeaseIPs(ipamLease *v1alpha1.IPAMClaim, ips []string) error {
	ret := _m.Called(ipamLease, ips)

	if len(ret) == 0 {
		panic("no return value specified for UpdateIPAMLeaseIPs")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(*v1alpha1.IPAMClaim, []string) error); ok {
		r0 = rf(ipamLease, ips)
	} else {
		r0 = ret.Error(0)
	}
